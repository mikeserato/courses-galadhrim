...
public class FPark implements Screen {
	...
	public  FPark (final StartLife gam, Character player1, Character player2) {
		...
		bg = new Texture(Gdx.files.internal("maps/fpark.jpg"));
