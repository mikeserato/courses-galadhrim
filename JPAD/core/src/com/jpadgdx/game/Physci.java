...
public class Physci implements Screen {
	...
	public  Physci (final StartLife gam, Character player1, Character player2) {
		...
		bg = new Texture(Gdx.files.internal("maps/physci.jpg"));
